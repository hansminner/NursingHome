...
<script src="/NursingHome/Public/js/logout.js"></script>
    ...
    <div class="index-row">
        <div class="news-ctn">
            ...
            <form action="" role="form" class="form-horizontal" method="post" id="newsForm">
                <?php if(is_array($news_detail)): $i = 0; $__LIST__ = $news_detail;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div id="<?php echo ($vo["id"]); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <!--WYSIWYG输入框-->
                                <div class="form-control" id="editor" contenteditable="true" style="overflow:scroll; /*max-*/height:300px; width:auto">
                                    <?php echo ($vo["content"]); ?>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" rows="2" name="key_words"
                                          required><?php echo ($vo["key_words"]); ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input id="cite" type="text" value="<?php echo ($vo["cite"]); ?>" class="form-control" name="cite"
                                       required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="type" required>
                                    <?php if(is_array($type_list)): foreach($type_list as $key=>$type_list): ?><option value="<?php echo ($type_list['type_id']); ?>"
                                        <?php if($vo['type'] == $type_list['type_id']): ?>selected<?php endif; ?>
                                        ><?php echo ($type_list['type']); ?></option><?php endforeach; endif; ?>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select id="" class="form-control" name="is_hot" required>
                                    <option value="1"
                                    <?php if($vo['is_hot'] == 1): ?>selected<?php endif; ?>
                                    >上头条</option>
                                    <option value="0"
                                    <?php if($vo['is_hot'] == 0): ?>selected<?php endif; ?>
                                    >下头条</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input id="priority" type="text" value="<?php echo ($vo["priority"]); ?>" class="form-control"
                                       name="priority" required>
                            </div>
                        </div>
                    </div><?php endforeach; endif; else: echo "" ;endif; ?>
                <div class="btn-group btn-group-lg text-center">
                    <button type="submit" class="btn btn-default" onclick="appendContent()">提交编辑</button>
                </div>
            </form>
        </div>
    </div>
